...
function desactivarModoNina() {
    ...
    // Reactivar TODAS las zonas — limpiar cualquier pointerEvents residual
    document.querySelectorAll('.zona').forEach(z => {
        z.style.pointerEvents = '';
        z.style.pointerEvents = 'auto'; // forzar reactivación explícita
        // pequeño reflow para asegurar que el navegador registre el cambio
    });
    // Segundo barrido con vacío para no dejar 'auto' hardcoded
    // (permite que el CSS normal tome el control)
...
(function() {
    ...
    function crearBloqueador() {
        ...
        bloqueador.innerHTML = '<style>' +
            ...
            '.ori-sub{font-family:sans-serif;font-size:clamp(.8rem,3.5vw,1.1rem);color:' + ORI_COLOR_SUB + ';white-space:pre-line;line-height:1.55;margin:0;}' +
            '</style>' +
        ...
        // Al tocar el bloqueador: intentar pantalla completa + activar audio ambiente
